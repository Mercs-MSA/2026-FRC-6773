...
public class IntakeConstants {
    ...
    public static RollerHardware rollerHardware = new RollerHardware(41, 18 / 24);

    public static PivotHardware pivotHardware = new PivotHardware(42, 15 / 1);

    public static PivotGains pivotGains = new PivotGains(
            0, // p
            0, // i
            0, // d
            0, // s
    ...
    public static final RollerTalonFXConfiguration kRollerMotorConfiguration = new RollerTalonFXConfiguration(
            false, // Invert
            true, // Enable stator current limiting
            true, // Enable supply current limiting
            60.0, // Stator limit
    ...
    public static final IntakeSimulationConfiguration pivotSimulationConfiguration = new IntakeSimulationConfiguration(DCMotor.getKrakenX60(1), 0.002);
    public static final IntakeSimulationConfiguration rollerSimulationConfiguration = new IntakeSimulationConfiguration(DCMotor.getKrakenX60(1), 0.002);
