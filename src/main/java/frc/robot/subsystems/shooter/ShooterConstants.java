...
public class ShooterConstants { // TODO: CLEANUP
    ...
    public static final ShooterFlywheelHardware flywheelHardware = new ShooterFlywheelHardware(56, 57, 6000 / 4800);

    public static final ShooterHoodHardware hoodHardware = new ShooterHoodHardware(
            55, 163.0 // TODO: Check and update
    );

    public static final ShooterTurretHardware turretHardware = new ShooterTurretHardware(53, 54, 102 / 25);

    public static final TurretMotorConfiguration turretConfigs = new TurretMotorConfiguration(false, true, true, 60, 50,
            12, -12, NeutralModeValue.Brake);
    public static final FlywheelMotorConfiguration flywheelConfigs = new FlywheelMotorConfiguration(true, false, false,
            60, 50, 12, -12, NeutralModeValue.Coast);
    public static final HoodMotorConfiguration hoodConfigs = new HoodMotorConfiguration(true, false, false, 60, 50, 12,
            -12, NeutralModeValue.Brake);

    public static final SimulationConfiguration shooterTurretSimConfig = new SimulationConfiguration(
            DCMotor.getKrakenX44(1), 0.002);
    public static final SimulationConfiguration shooterFlywheelSimConfig = new SimulationConfiguration(
            DCMotor.getKrakenX60(2), 0.002);
    public static final SimulationConfiguration shooterHoodSimConfig = new SimulationConfiguration(
            DCMotor.getKrakenX44(1), 0.002);

    public static final FlywheelGains flywheelGains = new FlywheelGains(0.2, 0.0, 0.0, 0.1, 0.126, 0.0);
    public static final HoodGains hoodGains = new HoodGains(70, 0, 0, 0.1, 0, 0);
    public static final TurretGains turretGains = switch (Constants.currentMode) {
