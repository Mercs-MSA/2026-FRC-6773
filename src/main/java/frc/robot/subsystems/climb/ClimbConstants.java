...
public class ClimbConstants {
    private final double climbVoltage = 15.0;
    ...
    public static final ClimbTalonFXConfiguration climbTalonFXConfiguration = new ClimbTalonFXConfiguration(
            false, // Invert
    ...
    public static final ClimbSimulationConfiguration climbSimulationConfiguration = new ClimbSimulationConfiguration(
            DCMotor.getKrakenX60(1), 0.002);
