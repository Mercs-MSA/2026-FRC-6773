...
public class TransferConstants {
	...
	public static final DoubleSupplier kRegulatorVelocity =
		() -> {
			return 4.0;
		}; // TODO: PUT PROPER VALUE HERE
	public static final DoubleSupplier kKickerVoltage =
			() -> {
				return 4.0;
			}; // TODO: PUT PROPER VALUE HERE
	public static final DoubleSupplier kMinRegulatorVelocityScalar =
			() -> {
				return 0.4;
			}; // percent of the shooter velocity that the transfer velocity has to be so ball reaches
	// shooter at desired speed TODO: PUT PROPER VALUE
}
