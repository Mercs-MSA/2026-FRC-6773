...
public class TransferConstants {
        ...
        public record TransferHardware(
                        int transferID,
                        double gearing,
                        double wheelRadIn) {
        }
        ...
        public static final TransferHardware transferHardware = new TransferHardware(// TODO: Gearing
                        52, 18 / 24, 1.5);

        public static final TransferGains transferGains = new TransferGains(
                        0,
                        0,
                        0,
                        0.1,
        ...
        public static final TransferTalonFXConfiguration transferTalonFXConfiguration = new TransferTalonFXConfiguration(
                        false, // Invert
        ...
        public static final TransferSimulationConfiguration transferSimulationConfiguration = new TransferSimulationConfiguration(
