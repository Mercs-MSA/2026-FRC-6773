...
public record ChoreoTraj(
	...
	public static final ChoreoTraj H_Partial_2Pass = new ChoreoTraj(
	    ...
	    OptionalInt.empty(),
	    7.24577,
	    new Pose2d(3.439, 2.227, Rotation2d.fromRadians(0.785)),
	    new Pose2d(3.2, 2.452, Rotation2d.fromRadians(-1.571))
	);
	public static final ChoreoTraj H_Partial_2Pass$0 = new ChoreoTraj(
	    ...
	    2.59562,
	    new Pose2d(3.439, 2.227, Rotation2d.fromRadians(0.785)),
	    new Pose2d(8.228, 1.061, Rotation2d.fromRadians(1.571))
	);
	public static final ChoreoTraj H_Partial_2Pass$1 = new ChoreoTraj(
	    ...
	    2.82668,
	    new Pose2d(8.228, 1.061, Rotation2d.fromRadians(1.571)),
	    new Pose2d(6.345, 2.467, Rotation2d.fromRadians(-1.571))
	);
