...
public final class ChoreoVars {
  ...
  public static final class Poses {
    ...
    public static final Pose2d H_BumpAlliance_Low =
        new Pose2d(3.2, 2.1, Rotation2d.fromRadians(1.571));
    public static final Pose2d H_BumpNeutral = new Pose2d(6.1, 2.5, Rotation2d.fromRadians(1.571));
    public static final Pose2d H_BumpNeutral_Low =
        new Pose2d(6.1, 2.1, Rotation2d.fromRadians(1.571));
