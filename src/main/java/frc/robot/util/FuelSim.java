...
public class FuelSim {
  ...
  public void registerOuttake(
      double xMin,
      double xMax,
      double yMin,
      double yMax,
      BooleanSupplier outtaking,
      double bps,
  ...
  protected class SimOuttake {
    double xMin, xMax, yMin, yMax;
    BooleanSupplier outtaking;
    double bps;

    LinearVelocity ballSpeed;

    protected SimOuttake(
        double xMin,
        double xMax,
        double yMin,
        double yMax,
        ...
        if (Math.random() < chance) {
          ...
          Translation3d robotVel =
              new Translation3d(
                  ...
                  robotFieldSpeedsSupplier.get().vyMetersPerSecond,
                  0);
